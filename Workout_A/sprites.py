...
def collide_with_walls(sprite, group, dir):     # needed to collide with walls
    if dir == 'x':
...
class Player(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        collide_with_walls(self, self.game.walls, 'x')   # colliding with walls - needed
        self.hit_rect.centery = self.pos.y
        collide_with_walls(self, self.game.walls, 'y')   # colliding with walls - needed
        self.rect.center = self.hit_rect.center


class Obstacle(pg.sprite.Sprite):           # notice, no image,
